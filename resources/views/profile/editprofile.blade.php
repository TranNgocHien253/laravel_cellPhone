            ...
            <div class="profile-update border p-3 mt-3">
                ...
                <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="user_fullname" class="form-control" name="user_fullname"
                            value="{{ $user->user_fullname }}" required autofocus>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" id="date_of_birth" class="form-control" name="date_of_birth"
                            value="{{ $profile->date_of_birth }}" required autofocus>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="radio" id="male" name="gender" value="Nam" required {{ (old('gender', $profile->gender) == 'Nam') ? 'checked' : '' }}>
                        <label for="male">Nam</label><br>
                        <input type="radio" id="female" name="gender" value="Nữ" required {{ (old('gender', $profile->gender) == 'Nữ') ? 'checked' : '' }}>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="phone_number" class="form-control" name="phone_number"
                            value="{{ $profile->phone_number }}" required autofocus>
